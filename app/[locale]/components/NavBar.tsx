...
const Navbar = () => {
  ...
  return (
    <>
      <div className="flex justify-between p-4 mr-3">
        <LangaugeSwitcher />
        {/* Toggle Button */}
        <button
        ...
        <nav
          ...
          } absolute lg:relative top-0 lg:top-auto left-0 lg:left-auto lg:right-auto bg-none p-8 lg:p-0 transform lg:mt-0 mt-12 ${
