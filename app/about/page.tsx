    ...
    >
      ...
      <div className="md:flex md:gap-16">
        ...
        <div className="w-full md:w-6/12">
          <p className="text-xl font-normal text-justify">
            ...
            to take part in CareersFoundry's bootcamp and return to what I love,
      ...
      <div>
        ...
        <p className="text-xl font-normal text-justify mt-12">
          I enjoy the full spectrum of web development, but I'm particularly
          passionate about integrating front-end and back-end technologies to
          create seamless user experiences. On the front-end, I love crafting
          interactive and visually appealing interfaces using modern frameworks
          like React or Angular. This involves a lot of creative problem-solving
          and design thinking, which are aspects I find deeply rewarding. On the
          back-end, I'm intrigued by the challenge of designing robust APIs and
          optimizing database interactions to ensure performance and
          scalability. Working with databases, whether SQL or NoSQL, allows me
          to structure data effectively and leverage it to drive the
          application's functionality. What excites me the most is seeing all
          these components come together into a cohesive and functional
          application that provides real value to users.
        </p>
      </div>
    </main>
  );
